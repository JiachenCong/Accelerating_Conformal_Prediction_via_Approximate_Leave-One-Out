...
rowNames={'(n=100,p=50,λ=1)','(n=100,p=100,λ=1)','(n=100,p=200,λ=1)'};
result=zeros(3,4);
...
disp(T_2);
writetable(T_1, 'JKplus_Results_lambda1.xlsx', 'Sheet', 'Sheet1', 'WriteRowNames', true);
writetable(T_2, 'JKplus_Results_app_lambda1.xlsx', 'Sheet', 'Sheet1', 'WriteRowNames', true);
%quantile functions
